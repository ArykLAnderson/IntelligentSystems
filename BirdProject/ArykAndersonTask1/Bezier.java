...
public class Bezier {
    ...
    private ArrayList<Point> bezierPoints(ArrayList<Point> positions, double step) {
    ...
    private ArrayList<Point> addSegments(ArrayList<Point> targetPoints) {
...
//            wPoint = new Point(0, 0, 0, false);
    ...
    private Point generatePoint(Point startPoint, Point midPoint, Point endPoint, double t, boolean endpoint) {
